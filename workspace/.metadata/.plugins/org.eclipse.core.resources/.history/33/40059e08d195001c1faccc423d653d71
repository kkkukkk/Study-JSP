						...
						<div class="inner">
							...
							<section class="main">
								...
								<form action="" name="" method="post">
									<header class="major">
										<p>
											<input id="" name="" type="text" placeholder="제목 입력" value="">
										</p>
										<p style="text-align:left; margin-bottom:1%; margin-top:-1.75em;">작성자 : </p>
									</header>
									...
									<div style="margin-top:3%;">
										<textarea name="board_content" placeholder="내용 작성" style="resize:none;" rows="30">${board.getBoard_content()}</textarea>
									</div>
									<ul class="actions" style="display:flex; justify-content:center; margin-top:3%;">
										<li><input type="button" value="수정완료" class="primary"/></li>
